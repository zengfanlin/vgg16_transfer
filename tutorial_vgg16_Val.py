...
tl.files.load_and_assign_npz(sess=sess, name='model3.npz', network=network)
file_dir = 'F:\\001-python\\Data\\catdog\\test_cat_\\'
filelist = []
count = 0
for file in os.listdir(file_dir):

    img1 = imread(file_dir + file, mode='RGB')  # test data in github
